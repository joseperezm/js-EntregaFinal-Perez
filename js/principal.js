...
const gradosJSON = `[
  ...
  { "nombre": "blanco", "descripcion": "El grado blanco marca el comienzo de un apasionante viaje en el mundo del Jiu-Jitsu Brasileño (BJJ). Este grado se caracteriza por sentar los cimientos fundamentales y promover una dedicación constante al aprendizaje y la práctica regular del BJJ. Durante esta etapa inicial, los practicantes adquieren un conocimiento sólido de las técnicas fundamentales, así como una comprensión básica de las posiciones y los principios de control y defensa. Además, se enfatiza el desarrollo de una mentalidad disciplinada y perseverante. Los estudiantes de grado blanco se animan a establecer una rutina de entrenamiento constante, familiarizarse con los conceptos básicos del arte marcial y disfrutar del proceso de aprendizaje y crecimiento en el Jiu-Jitsu Brasileño. A medida que avanzan en este grado, sentarán una base sólida que les permitirá progresar y explorar las complejidades y sutilezas del BJJ en grados superiores." },
...
botonLogout.addEventListener("click", function () {
  ...
  formulario.grado.value = "ninguno";
